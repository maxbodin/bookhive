...
VALUES (user_id, 'test.user@example.com',
        'https://thumbs.dreamstime.com/b/crash-test-dummy-20256432.jpg') ON CONFLICT (id) DO NOTHING;

-- 4. Insert sample books into the 'books' table
-- These are the books that will be associated with the user.
INSERT INTO public.books (id, title, authors, pages, publication_date, type)
VALUES (2001, 'The Midnight Library', '{"Matt Haig"}', 304, '2020-08-13', 'roman'),
       ...
       (2020, 'The Catcher in the Rye', '{"J. D. Salinger"}', 224, '1951-07-16', 'roman') ON CONFLICT (id) DO
UPDATE SET
...
INSERT INTO public.users_books (uid, book_id, state, start_wishlist_date, end_wishlist_date, start_later_date,
                                end_later_date, start_reading_date, end_reading_date, read_date, is_favorite,
                                current_page)
VALUES
-- =====================================================================================
-- YEAR 2022
-- =====================================================================================
-- Read Books in 2022
(user_id, 2020, 'read', '2022-01-05T10:00:00Z', '2022-02-20T11:00:00Z', '2022-02-20T11:00:01Z', '2022-03-15T18:00:00Z',
 '2022-03-15T18:00:01Z', '2022-03-25T22:30:00Z', '2022-03-25T22:30:00Z', false, 224),              -- The Catcher in the Rye
(user_id, 2016, 'read', '2022-04-01T12:00:00Z', '2022-05-10T14:00:00Z', NULL, NULL, '2022-05-10T14:00:01Z',
 '2022-05-11T20:00:00Z', '2022-05-11T20:00:00Z', true, 192),                                       -- Naruto, Vol. 1 (quick read)
(user_id, 2015, 'read', NULL, NULL, '2022-01-01T00:00:00Z', '2022-08-01T09:00:00Z', '2022-08-01T09:00:01Z',
 '2022-08-10T21:00:00Z', '2022-08-10T21:00:00Z', true, 224),                                       -- The Hitchhiker's Guide to the Galaxy
(user_id, 2009, 'read', '2022-06-10T16:00:00Z', '2022-09-01T10:00:00Z', '2022-09-01T10:00:01Z', '2022-10-02T19:00:00Z',
 '2022-10-02T19:00:01Z', '2022-10-20T23:15:00Z', '2022-10-20T23:15:00Z', false, 328),              -- 1984
-- =====================================================================================
-- YEAR 2023
-- =====================================================================================
-- Read Books in 2023
(user_id, 2001, 'read', '2022-12-01T11:00:00Z', '2023-01-09T08:00:00Z', NULL, NULL, '2023-01-10T09:00:00Z',
 '2023-01-20T18:00:00Z', '2023-01-20T18:00:00Z', true, 304),                                       -- The Midnight Library
(user_id, 2002, 'read', NULL, NULL, '2022-10-20T12:00:00Z', '2023-02-04T10:00:00Z', '2023-02-05T12:00:00Z',
 '2023-02-25T20:00:00Z', '2023-02-25T20:00:00Z', true, 496),                                       -- Project Hail Mary
(user_id, 2011, 'read', NULL, NULL, NULL, NULL, '2023-04-02T10:00:00Z', '2023-04-03T11:00:00Z', '2023-04-03T11:00:00Z',
 true, 224),                                                                                       -- Berserk, Vol. 1 (bought and read immediately)
(user_id, 2013, 'read', '2023-01-15T19:00:00Z', '2023-04-09T17:00:00Z', NULL, NULL, '2023-04-10T18:00:00Z',
 '2023-04-12T23:00:00Z', '2023-04-12T23:00:00Z', false, 240),                                      -- The Sandman, Vol. 1
(user_id, 2017, 'read', NULL, NULL, NULL, NULL, '2023-07-07T13:00:00Z', '2023-07-21T16:45:00Z', '2023-07-21T16:45:00Z',
 true, 288),                                                                                       -- The Colour of Magic
(user_id, 2014, 'read', '2023-05-20T10:00:00Z', '2023-08-30T10:00:00Z', '2023-08-30T10:00:01Z', '2023-10-10T14:00:00Z',
 '2023-10-10T14:00:01Z', '2023-11-05T21:00:00Z', '2023-11-05T21:00:00Z', true, 279),               -- Pride and Prejudice
(user_id, 2003, 'reading', NULL, NULL, '2022-12-25T20:00:00Z', '2023-06-01T15:00:00Z', '2023-06-01T15:00:01Z', NULL,
 NULL, false, 250),
-- =====================================================================================
-- YEAR 2024
-- =====================================================================================
-- Read books in 2024
(user_id, 2007, 'read', '2022-11-15T14:30:00Z', '2023-12-28T18:00:00Z', '2023-12-28T18:00:01Z', '2024-01-01T09:59:00Z',
 '2024-01-01T10:00:00Z', '2024-02-15T19:00:00Z', '2024-02-15T19:00:00Z', true,
 1178),                                                                                            -- The Lord of the Rings (the big one)
(user_id, 2012, 'read', NULL, NULL, NULL, NULL, '2024-03-01T12:30:00Z', '2024-03-02T14:00:00Z', '2024-03-02T14:00:00Z',
 false, 208),                                                                                      -- One Piece, Vol. 1
(user_id, 2018, 'read', '2023-10-01T00:00:00Z', '2024-03-15T17:00:00Z', NULL, NULL, '2024-03-16T11:00:00Z',
 '2024-03-18T22:45:00Z', '2024-03-18T22:45:00Z', true, 296),                                       -- Maus
-- Currently Reading in 2024
(user_id, 2004, 'reading', '2023-02-10T11:00:00Z', '2024-04-30T12:00:00Z', NULL, NULL, '2024-05-01T10:00:00Z', NULL,
 NULL, false, 210),                                                                                -- The Hobbit
(user_id, 2005, 'reading', '2024-01-01T09:00:00Z', '2024-05-09T15:00:00Z', NULL, NULL, '2024-05-10T11:00:00Z', NULL,
 NULL, true, 80),                                                                                  -- Atomic Habits
...
(user_id, 2010, 'wishlist', '2024-05-05T13:00:00Z', NULL, NULL, NULL, NULL, NULL, NULL, false,
 0) -- A Brief History of Time
;


-- 6. Add a large number of reading sessions for a rich history
INSERT INTO public.reading_sessions (uid, book_id, start_time, end_time, start_page, end_page, notes)
VALUES
